# Codigo 16: Removed File

## Funcionalidad
Listar y recuperar documentos de una carpeta "Urna".
En este caso la carpeta del basurero

### **Requerimientos**
Tener una carpeta de trash

### **Anotaciones**
La carpeta de trash usada es la mia y no la del codigo pues en este usan una carpeta especifica

### **[Codigo 16: Removed File](removedFile16.sh)**
